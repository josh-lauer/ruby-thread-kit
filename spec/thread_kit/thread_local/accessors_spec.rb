...
describe ThreadKit::ThreadLocal::Accessors do
  ...
  def assert_instance_method_writer_defined(method_name, relative_to: klass_instance)
  ...
  def assert_singleton_method_writer_defined(method_name)
    method_name = (method_name.to_s + '=').squeeze('=').to_sym
    store_key = method_name.to_s.sub(/\=$/, '').to_sym
    expect(klass).to respond_to(method_name)
  ...
  describe "#tl_attr_accessor" do
    ...
    it("does not define a class reader") { assert_singleton_method_not_defined(:tl_aa) }
    it("does not define a class writer") { assert_singleton_method_not_defined(:tl_aa=) }
  end
  ...
  describe "#tl_attr_reader" do
    ...
    it("does not define a class reader") { assert_singleton_method_not_defined(:tl_ar) }
    it("does not define a class writer") { assert_singleton_method_not_defined(:tl_ar=) }
  end
  ...
  describe "#tl_attr_writer" do
    ...
    it("does not define a class reader") { assert_singleton_method_not_defined(:tl_aw) }
    it("does not define a class writer") { assert_singleton_method_not_defined(:tl_aw=) }
  end
